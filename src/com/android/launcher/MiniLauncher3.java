...
public class MiniLauncher3 extends ViewGroup implements View.OnLongClickListener, DropTarget,
    ...
    public MiniLauncher3(Context context) {
        super(context);
    	mFlingGesture = new FlingGesture(context);
    }

    public MiniLauncher3(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MiniLauncher3(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onDrop(DragSource source, int x, int y, int xOffset, int yOffset, Object dragInfo) {
        ...
        if(accept){
	        ...
	        LauncherModel.addOrMoveItemInDatabase(mLauncher, info,
	                LauncherSettings.Favorites.CONTAINER_DOCKBAR3, -1, info.cellX, -1);
	        ...
	        for(int i = 0; i < getChildCount(); i++) {
	        	...
	        	if (childInfo != info && childInfo.cellX >= info.cellX) {
	                ...
	                LauncherModel.moveItemInDatabase(mLauncher, childInfo,
	                        LauncherSettings.Favorites.CONTAINER_DOCKBAR3, -1, childInfo.cellX, -1);
	        	}
	        }
    ...
    public void addItemInDockBar(ItemInfo info){
        ...
        case LauncherSettings.Favorites.ITEM_TYPE_SHORTCUT:
            ...
            view = mLauncher.createSmallShortcut(R.layout.small_application3, this,
                    (ApplicationInfo) info);
            break;
        case LauncherSettings.Favorites.ITEM_TYPE_LIVE_FOLDER:
            view = mLauncher.createSmallLiveFolder(R.layout.small_application3, this,
                    (LiveFolderInfo) info);
            break;
        case LauncherSettings.Favorites.ITEM_TYPE_USER_FOLDER:
            view = mLauncher.createSmallFolder(R.layout.small_application3, this,
                    (UserFolderInfo) info);
            break;
        case LauncherSettings.Favorites.ITEM_TYPE_APPWIDGET:
