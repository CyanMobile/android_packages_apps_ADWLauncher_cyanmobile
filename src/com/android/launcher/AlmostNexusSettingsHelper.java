...
public final class AlmostNexusSettingsHelper {
	...
	public static boolean getUIDockbar3(Context context) {
		SharedPreferences sp = context.getSharedPreferences(ALMOSTNEXUS_PREFERENCES, Context.MODE_PRIVATE);
		boolean newD = sp.getBoolean("uiDockbar3", context.getResources().getBoolean(R.bool.config_uiDockbar3));
		return newD;
	}
	...
	public static boolean shouldShowChangelog(Context context) {
		...
		if(config){
			...
			String actualV=context.getString(R.string.cyan_version);
	...
	public static class ChangelogDialogBuilder {
		public static AlertDialog create( Context context ) throws NameNotFoundException {
			...
			String aboutTitle = String.format("%s Changelog", context.getString(R.string.cyan_version));
			...
			return new AlertDialog.Builder(context).setTitle(aboutTitle).setCancelable(true).setIcon(R.drawable.cm_icon).setPositiveButton(
